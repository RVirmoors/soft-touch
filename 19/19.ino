...
OSCErrorCode error;
const unsigned int outPort = 9919;          // remote port to send OSC to Max
const unsigned int localPort = 8819;        // local port to listen for OSC packets
